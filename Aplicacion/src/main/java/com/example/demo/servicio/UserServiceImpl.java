...
import com.example.demo.excepcion.CustomerFieldValidationException;
	...
	public class UserServiceImpl implements UserService{
		...
		private boolean checkUsernameAvailable(User user) throws Exception {
			...
			if (userFound.isPresent()) {
				throw new CustomerFieldValidationException("Username no disponible","username");
			}
			return true;
		}
		...
		private boolean checkPasswordValid(User user) throws Exception {
			if (user.getConfirmPassword() == null || user.getConfirmPassword().isEmpty()) {
				throw new CustomerFieldValidationException("Confirm Password es obligatorio","confirmPassword");
			}
			
			if ( !user.getPassword().equals(user.getConfirmPassword())) {
				throw new CustomerFieldValidationException("Password y Confirm Password no son iguales","password");
			}
			return true;
		}
